    ...
    var body: some View {
        NavigationStack {
            ...
            Group {
                ...
                Divider()
                    .padding(.horizontal, 30)
                SecureField("Confirm Password", text: $userData.password2)
                    .padding(.horizontal, 30).padding(.top, 20)
                Divider()
                    .padding(.horizontal, 30)
                TextField("Birthdate (MM/DD/YYYY)", text: $userData.birthDate)
                    .padding(.horizontal, 30).padding(.top, 20)
                Divider()
                    .padding(.horizontal, 30)
            }
            ...
            VStack {
                if (userData.password1 != userData.password2) {
                        Text("Passwords Must Match")
                            .foregroundColor(.red)
                            .position(x: 198, y: -375)
                    }
            
                    NavigationLink("Create", destination: Choice())
